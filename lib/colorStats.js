...
module.exports = function(iterator) {
    ...
    iterator.eachColor(function(color, origProp) {
        colorsByProp.all.push(color);

        prop = vendor.unprefixed(origProp);
    ...
    function groupAndSortColors(colors) {
        return _(colors).groupBy(function(color) {
            ...
            return {color: hexColor, count: _(variants).reduce(function(a,b){return a+b;}, 0)};
        }).sortBy(function(obj){
            return toSortableColorNumber(obj.color);
        }).value();
    }
